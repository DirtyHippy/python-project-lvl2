...
@pytest.mark.parametrize("file1, file2, fixture, format", [(simple_json1, simple_json2, 'simple_expected_value', STYLISH),                # noqa E501
...
def test_1(file1, file2, fixture, format, request):
